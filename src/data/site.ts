...
export const business = {
  ...
  mapEmbed:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31686.5!2d79.92!3d6.80!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwNDgnMDYuNCJOIDc5wrA1NSc0MS43IkU!5e0!3m2!1sen!2slk!4v1700000000000",
  social: {
...
export const services: Service[] = [
  {
    ...
    description:
      "From cracked screens to dead motherboards, our certified technicians repair all major laptop brands including Dell, HP, Lenovo, ASUS, Acer, and Apple. We use genuine parts and back every repair with a warranty.",
    features: [
      "Screen replacement",
      "Keyboard repair",
      "Battery replacement",
  ...
  },
  {
    ...
    description:
      "Whether your desktop won't boot, keeps crashing, or just needs a performance boost, we diagnose and fix it fast. Hardware and software issues, component upgrades, thermal repasting, and full system optimization.",
    features: [
  ...
  },
  {
    ...
    description:
      "Tell us your budget and favorite games — we'll build the perfect gaming PC. From entry-level 1080p rigs to 4K ultra beasts, every build is cable-managed, stress-tested, and benchmarked before delivery.",
    features: [
      "Custom part selection",
      "RGB lighting setup",
      "Cable management",
      "Liquid cooling install",
      "Overclocking & tuning",
      "Stress testing",
      "3DMark benchmarking",
      "Game optimization",
  ...
  },
  {
    ...
    description:
      "Wi-Fi dead zones? Slow internet? Need a wired office network? We design, install, and configure networks that just work. From mesh Wi-Fi to enterprise switches, we handle it all.",
    features: [
      "Wi-Fi mesh setup",
      "Router configuration",
      "LAN cabling",
      "Network switch install",
      "Firewall setup",
      "VPN configuration",
  ...
  },
  {
    ...
    description:
      "Protect your home or business with professional CCTV systems. We supply, install, and configure HD and IP camera systems with remote viewing, night vision, and motion alerts — all accessible from your phone.",
    features: [
      "HD/IP camera install",
      "DVR/NVR setup",
  ...
  },
  {
    ...
    description:
      "Accidentally deleted files? Corrupted drive? Dropped your external HDD? Our data recovery specialists use advanced tools to recover data from HDDs, SSDs, USB drives, and memory cards — even from physically damaged drives.",
    features: [
      "Logical recovery",
      "Physical recovery",
      "Partition repair",
  ...
  },
  {
    ...
    description:
      "Paper jams, streaky prints, connectivity issues — we repair all printer types and brands. Inkjet, laser, all-in-one, and thermal printers serviced with genuine parts and consumables.",
    features: [
      "Paper jam fix",
      "Print head cleaning",
      "Ink system flush",
  ...
  },
  {
    ...
    description:
      "Operating systems, office suites, design tools, development environments — we install and configure everything properly, with genuine licenses and proper activation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Is your TV not turning on, showing a blank screen, having sound problems, or displaying unusual lines and colors? We provide professional TV repair and troubleshooting services for common hardware and display issues. Our technicians diagnose the problem carefully and provide a reliable repair solution to get your TV working properly again.",
    features: [
      "TV power issue repair",
      "Blank screen troubleshooting",
      "Display and picture problem repair",
      "Sound problem troubleshooting",
      "HDMI and input issue repair",
      "Backlight problem repair",
      "TV motherboard troubleshooting",
      "Professional TV diagnostics",
    ],
    startingPrice: "Contact for Pricing",
    duration: "Same day – 2 days",
  },
  {
    ...
    description:
      "Fresh Windows 10/11 installation with all drivers, essential software, and optimization. We back up your data first, install genuine OS, and configure everything for peak performance.",
    features: [
  ...
  },
  {
    ...
    description:
      'Our advanced technicians perform component-level motherboard repair using micro-soldering, thermal imaging, and oscilloscope diagnostics. We fix what others call "unrepairable."',
    features: [
      "Micro-soldering",
      "Chip replacement",
      "Power circuit repair",
      "Thermal imaging diag",
      "BGA reflow/reballing",
...
export const products: Product[] = [
  ...
  // ############Coponents#
  {
    ...
    price: 0,
    image: "/products/msata.jpeg",
    rating: 4,
    badge: "Used",
    warranty: "3-Month Warranty",
    description:
      "Kim MID 128GB mSATA SSD, 3.3V 1A interface, suitable for compatible laptops and compact systems.",
    specs: [
      "128GB Capacity",
      "mSATA Interface",
      "3.3V / 1A",
  ...
  },
  {
    ...
    subcategory: "Components",
    price: 0,
    image: "/products/ddr4 8gb desktop.jpeg",
    rating: 4,
    badge: "Used",
    warranty: "3-Month Warranty",
    description:
      "Reliable 8GB DDR4 desktop RAM, suitable for compatible desktop computers and PC upgrades.",
    specs: [
      "8GB DDR4 RAM",
      "Desktop DIMM",
      "2Rx8 Memory",
  ...
  {
    id: "p18",
    name: "SSD Mini NVMe 256GB",
    category: "Components & Accessories",
    subcategory: "Components",
    price: 0,
    image: "/products/mini nvme.jpeg",
    rating: 4,
    badge: "Used",
    warranty: "3-Month Warranty",
    description:
      "WD PC SN740 256GB M.2 2230 NVMe SSD with PCIe Gen3 x4 interface, designed for compatible laptops, compact PCs and portable devices.",
    specs: [
  ...
  },
  {
    ...
    subcategory: "Components",
    price: 0,
    image: "/products/1tb.jpeg",
    rating: 4,
    badge: "Used",
    warranty: "2-Year Warranty",
    description:
      "Reliable 1TB hard disk drive suitable for desktop computers, laptops, storage upgrades and data backup.",
    specs: [
...

  {
    ...
    warranty: "3 Warranty",
    description:
      "Full Set PC Intel Core | DDR3 8GB RAM | SSD | HDD | 19” LED Monitor",
    specs: [
      "Intel Core I3 / I5",
      "DDR3 8GB RAM",
      "SSD & HDD",
...
"Used / Refurbished Condition"
  ...
  // ####################################################################################### *CCTV* #####
  {
    ...
    category: "CCTV",
    price: 0,
    image: "/products/4g 3lens camera.jpeg",
    rating: 5,
    badge: "new",
    warranty: "6-Month Warranty",
    description:
      "4G 3-Lens Outdoor CCTV Camera with PTZ rotation, night vision, motion detection and remote mobile monitoring.",
    specs: [
      "4G SIM Supported",
      "3-Lens Camera System",
  ...
  {
    id: "p20",
    name: "4G Dual-Lens CCTV Camera",
    category: "CCTV",
    price: 0,
    image: "/products/4g 2lens camera.jpeg",
    rating: 5,
    badge: "new",
    warranty: "6-Month Warranty",
    description:
      "4G Dual-Lens Outdoor CCTV Camera with PTZ rotation, full-color night vision, motion detection and remote mobile monitoring. Ideal for homes, shops, offices and outdoor security.",
    specs: [
      "4G SIM Supported",
      "Dual-Lens Camera System",
      "PTZ Pan & Tilt Rotation",
      "Full-Color Night Vision",
      "Motion Detection",
      "Remote Mobile Monitoring",
      "Two-Way Audio",
  ...
  {
    id: "p19",
    name: "4G Single-Lens V380 Pro Camera",
    category: "CCTV",
    price: 0,
    image: "/products/4g single lens v380 pro camera.jpeg",
    rating: 5,
    badge: "new",
    warranty: "6-Month Warranty",
    description:
      "4G Single-Lens V380 Pro Outdoor CCTV Camera with PTZ rotation, full-color night vision, motion detection and remote mobile monitoring. Ideal for homes, shops, offices and outdoor security.",
    specs: [
      "4G SIM Supported",
      "Single-Lens Camera System",
      "V380 Pro App Support",
      "PTZ Pan & Tilt Rotation",
      "Full-Color Night Vision",
      "Motion Detection",
      "Remote Mobile Monitoring",
  ...
  {
    id: "p16",
    name: "SanDisk Ultra 128/64/32 GB microSDXC Memory Card",
    category: "CCTV",
    price: 0,
    image: "/products/sandisk ultra 128gb.jpeg",
    rating: 5,
    badge: "new",
    warranty: "6-Month Warranty",
    description:
      "SanDisk Ultra 128GB microSDXC memory card with UHS-I interface, Class 10 performance and A1 application rating. Ideal for smartphones, CCTV cameras, tablets, action cameras and other compatible devices.",
    specs: [
      "128/64/32 Storage Capacity",
      "microSDXC Memory Card",
      "UHS-I Interface",
      "Class 10 Speed Rating",
      "A1 Application Performance",
      "Ideal for CCTV Cameras",
      "Suitable for Smartphones & Tablets",
...
export const reviews: Review[] = [
  {
    ...
    name: "Dinusha Perera",
    rating: 5,
    text: "My laptop had a completely dead motherboard and three other shops said it was unrepairable. RK Tech fixed it in two days for a fair price. Absolute lifesavers!",
    date: "2024-12-15",
  ...
  },
  {
    ...
    name: "Saman Silva",
    rating: 5,
    text: "Built me a gaming PC that runs everything on ultra at 1440p. The cable management is a work of art. Highly recommend for any gamer in Piliyandala.",
    date: "2024-12-10",
  ...
  },
  {
    ...
    rating: 5,
    text: "They came to my home to set up the entire CCTV system. Professional, on time, and the mobile app makes checking cameras so easy. Very happy.",
    date: "2024-11-28",
  ...
  },
  {
    ...
    rating: 5,
    text: "Recovered all my wedding photos from a corrupted USB drive. I thought they were gone forever. Worth every rupee. Thank you RK Tech!",
    date: "2024-11-20",
  ...
  {
    id: "r5",
    name: "Pubudu Nayanamini",
    rating: 5,
    text: "Fast and honest service. They diagnosed my desktop issue for free and the repair was done same-day. No unnecessary upselling like other shops.",
    date: "2024-11-15",
  ...
  },
  {
    ...
    rating: 5,
    text: "Set up mesh Wi-Fi across my entire house. No more dead zones in any room. The team really knows their stuff with networking.",
    date: "2024-11-08",
    service: "Networking",
    avatar: "TM",
  },
...
export const faqs = [
  {
    q: "Do you offer same-day TV repairs?",
    a: "Yes! Many common TV issues can be diagnosed and repaired the same day. Simple problems such as power issues, sound problems, HDMI/input issues, and some display or backlight problems may be completed within the same day. More complex repairs, such as motherboard or panel-related issues, may take longer depending on the problem and availability of replacement parts.",
  },
  {
    q: "Do you provide a warranty on repairs?",
    a: "Absolutely. Every repair comes with a minimum 30-day service warranty. Parts replacements carry the manufacturer warranty (typically 1–5 years). We stand behind every repair we do.",
  },
  {
    q: "Do you offer home/office visits?",
    a: "Yes, we provide on-site service for networking, CCTV installation, and certain desktop/printer issues within Colombo and nearby areas. Call us to schedule a visit.",
  },
  {
    q: "How much does a diagnostic cost?",
    a: "Diagnostics are completely free. We'll assess your device, identify the problem, and give you a transparent quote before any work begins. No hidden charges.",
  },
  {
    q: "Can you recover data from a physically damaged drive?",
    a: "In most cases, yes. We use advanced tools for both logical and physical data recovery. For severely damaged drives, we partner with specialized clean-room facilities. Bring it in for a free assessment.",
  },
  {
    q: "Do you sell genuine products with warranty?",
    a: "Yes. All products we sell are 100% genuine with manufacturer warranty. We are authorized dealers for many major brands and every product receipt includes full warranty details.",
  },
  {
    q: "Can I get a quote before bringing my device?",
    a: "Of course! You can call us, message us on WhatsApp, or use the online quote request form on our website. We'll give you an estimated cost range based on your described issue.",
  },
  {
    q: "What payment methods do you accept?",
    a: "We accept cash, bank transfer, and all major credit/debit cards. For large purchases like gaming PC builds, we also offer installment plans through partner banks.",
  },
];
...
export const offers = [
  {
    id: "o1",
    title: "New Year Mega Used",
    desc: "Up to 20% off all gaming laptops & components",
    code: "NEWYEAR20",
    expiry: "Limited Time",
    icon: "Sparkles",
  },
  {
    id: "o2",
    title: "Free Diagnostic Month",
    desc: "Free diagnostics for all repair services — no hidden fees",
    code: "FREECHECK",
    expiry: "This Month",
    icon: "Search",
  },
  {
    ...
    desc: "Free RGB keyboard & mouse with any custom build over Rs. 200K",
    code: "RGBBUNDLE",
...
export const whyChooseUs = [
  {
    ...
    desc: "Most repairs completed within 24 hours so you're never without your device for long.",
  },
  {
    icon: "ShieldCheck",
    title: "Genuine Parts & Warranty",
    desc: "Only genuine parts, every repair backed by our service warranty. No shortcuts.",
  },
  {
    icon: "Home",
    title: "We Come To You",
    desc: "On-site service for networking, CCTV, and desktop issues across Piliyandala.",
  },
  {
    icon: "Award",
    title: "Certified Technicians",
    desc: "Our team holds certifications from CompTIA, Microsoft, and major hardware vendors.",
  },
  {
    icon: "Wallet",
    title: "Transparent Pricing",
    desc: "Free diagnostics, upfront quotes, and no hidden fees. You approve before we start.",
  },
  {
    icon: "Clock",
    title: "7 Days a Week",
    desc: "Open Monday through to Saturday 9AM–8PM, and Sundays 10AM–5PM for your convenience.",
  },
];
