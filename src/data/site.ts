...
export const products: Product[] = [
  ...
  // { id: 'p11', name: 'RAM', category: 'Monitors', price: 13,500, oldPrice: 14,500, image: 'monitor-4k', rating: 5, badge: 'Used', warranty: '3-Month Warranty', description: 'Ram', specs: ['27" UHD IPS', '3840x2160', 'HDR400', 'USB-C 90W', 'Height Adjustable'] },
