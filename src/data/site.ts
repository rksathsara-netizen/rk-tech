...
export const reviews: Review[] = [
  ...
  { id: 'r4', name: 'Kasun Rajapaksa', rating: , text: 'Recovered all my wedding photos from a corrupted USB drive. I thought they were gone forever. Worth every rupee. Thank you RK Tech!', date: '2024-11-20', service: 'Data Recovery', avatar: 'KR' },
