...
export const products: Product[] = [
 ...
 // ##### *Coponents & Accessories* #####
    // #Coponents#
       ...
       { id: 'p14', name: 'HDD 1TB', stock: "in-stock", category: 'Components & Accessories', subcategory: 'Components', price: 100, oldPrice: 10, image: '/products/1tb.jpeg', rating: 5, badge: 'Used', warranty: '2-Year Warranty', description: 'Intel i9, RTX 4070, 16GB DDR5, 1TB SSD, 16" QHD 240Hz', specs: ['Intel Core i9-14900HX', 'RTX 4070 8GB', '16GB DDR5', '1TB NVMe SSD', '16" QHD 240Hz'] },
