...
export const products: Product[] = [
  ...
  { id: 'p7', name: 'DDR4 8GB Laptop Ram', category: 'Accessories', price: 19500, image: 'mouse', rating: 5, badge: 'sale', badge: 'warranty', warranty: '3-Month Warranty', description: 'Ultra-light wireless gaming mouse, 30K DPI optical sensor', specs: ['63g Ultralight', '30,000 DPI Sensor', '90hr Battery', 'Optical Gen-3 Switches', 'HyperSpeed Wireless'] },
