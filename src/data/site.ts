...
export const products: Product[] = [
 ...
 // ####### *Coponents & Accessories* #####
    // #Coponents#
       ...
       { id: 'p18', name: 'SSD Mini NVMe 256GB', category: 'Components & Accessories', subcategory: 'Components', price: 0, image: '/products/mini nvme.jpeg', rating: 4, badge: 'Used', warranty: '3-Month Warranty', description: 'WD PC SN740 256GB M.2 2230 NVMe SSD with PCIe Gen3 x4 interface, designed for compatible laptops, compact PCs and portable devices.', specs: ['256GB Storage Capacity', 'M.2 2230 Form Factor', 'NVMe PCIe Gen3 x4', 'WD PC SN740 Series', '3.3V / 2.5A', 'Compact Laptop Compatible', 'High-Speed Solid State Storage'] },
